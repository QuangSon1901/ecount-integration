...
class YunExpressCNService extends BaseCarrier {
    constructor(config) {
        super(config);
        this.name = 'YunExpressCN';
        this.baseUrl = config.yunexpress_cn.baseUrl;
        this.appId = config.yunexpress_cn.appId;
        this.appSecret = config.yunexpress_cn.appSecret;
        this.sourceKey = config.yunexpress_cn.sourceKey;
...
module.exports = YunExpressCNService;